...
class AppTheme {
  ...
  static TextStyle getDescriptionStyle(bool isDarkMode) => TextStyle(
        fontSize: 14,
        color: isDarkMode ? darkTheme['descriptionColor']! : lightTheme['descriptionColor']!,
      );

  static List<Color> getBackgroundGradient(bool isDarkMode) =>
      isDarkMode ? darkGradients['backgroundGradient']! : lightGradients['backgroundGradient']!;

  static List<Color> getAccentGradient(bool isDarkMode) =>
      isDarkMode ? darkGradients['accentGradient']! : lightGradients['accentGradient']!;

  static List<Color> getCardGradient(bool isDarkMode) =>
      isDarkMode ? darkGradients['cardGradient']! : lightGradients['cardGradient']!;

  static Color getPatternColor(bool isDarkMode) => isDarkMode ? const Color(0xFF3A3A3A) : const Color(0xFFE0E0E0);
  ...
  // Layout constants
  static const double cardHeight = 30; // Adjust based on your card's actual height
  static const double cardMargin = 16;
  static const double cardBorderRadius = 4;
  static const double cardPadding = 16;
  static const double accentBarHeight = 4;
  static const double accentBarWidth = 48;
  static const double accentBarRadius = 2;
}
