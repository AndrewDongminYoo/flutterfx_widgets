...
class SwirlFloatStrategy extends BaseAnimationStrategy {
  // Controls the intensity of the S curve
  ...
  Widget buildAnimatedCharacter({
    ...
    final yDeviation = random.nextDouble() * yOffset.abs() * (yOffset >= 0 ? 1 : -1);
      ...
      builder: (context, value, _) {
        ...
        if (enableBlur) {
          if (enableBlur) {
            ...
            final blurProgress =
                value < blurThreshold ? maxBlur : maxBlur * (1 - ((value - blurThreshold) / (1 - blurThreshold)));
